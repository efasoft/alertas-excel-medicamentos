...
# Configuración
DIAS_ALERTA = 3
FILA_INICIO = 18  # Empezar desde la fila 18
...
def extraer_imagen_paciente(sheet):
    """Extrae la imagen del paciente del Excel (si existe)"""
    try:
        # Intentar obtener la imagen del shape "RECTANGULO REDONDEADAS 10"
        ...
        log("⚠️ No se encontró imagen del paciente en el Excel")
        return None
    except Exception as e:
        log(f"⚠️ No se pudo extraer la imagen: {str(e)}")
        return None
...
def leer_info_paciente(sheet):
    ...
    try:
        ...
        # Intentar extraer la imagen del paciente
        imagen_base64 = extraer_imagen_paciente(sheet)
...
def crear_html_email_personalizado(alertas, info_paciente):
    ...
    # URL de la imagen del paciente (si existe)
    imagen_paciente_html = ""
    if info_paciente.get('imagen'):
        imagen_paciente_html = f'<img src="data:image/png;base64,{info_paciente["imagen"]}" alt="Foto del paciente" class="foto-paciente">'
    else:
        # Placeholder si no hay imagen
        imagen_paciente_html = '<div class="foto-placeholder"><i class="fas fa-user-circle"></i></div>'
...
<head>
    ...
    <style>
        * {{
        ...
        .seccion-hoy .seccion-titulo {{
            background: linear-gradient(135deg, #ff6b6b, #ee5a6f);
            color: white;
        }}
        
        .seccion-manana .seccion-titulo {{
            background: linear-gradient(135deg, #ffa502, #ff7f50);
            color: white;
        }}
        
        .seccion-proximas .seccion-titulo {{
...
<body>
    ...
    if alertas_hoy:
        html += """
            <div class="seccion seccion-hoy">
                <div class="seccion-titulo">
                    <i class="fas fa-exclamation-circle"></i>
                    <span>URGENTE - Revisión HOY</span>
                </div>
        """
                ...
                <div class="medicamento-card card-hoy">
                    <div class="medicamento-header">
                        <div class="medicamento-info">
                            ...
                            <div class="medicamento-uso">
                                <i class="fas fa-notes-medical"></i>
                                {alerta['uso']}
                            </div>
                        </div>
                        <span class="badge-urgencia badge-hoy">
                    ...
                    <div class="medicamento-footer">
                        <div class="fecha-info">
                            ...
                            <strong>Fecha de revisión:</strong> {alerta['fecha'].strftime('%d/%m/%Y')}
                        </div>
                        <div class="fecha-info">
                            <i class="fas fa-hourglass-end"></i>
                            <strong>Días restantes:</strong> 0
                        </div>
                    </div>
                </div>
            """
    ...
    if alertas_manana:
        html += """
            <div class="seccion seccion-manana">
                <div class="seccion-titulo">
                    <i class="fas fa-bell"></i>
                    <span>IMPORTANTE - Revisión MAÑANA</span>
                </div>
        """
            ...
            html += f"""
                <div class="medicamento-card card-manana">
                    <div class="medicamento-header">
                        ...
                        <span class="badge-urgencia badge-manana">
                            <i class="fas fa-clock"></i>
                            MAÑANA - 1 día
                        </span>
                    </div>
                    <div class="medicamento-footer">
                        ...
                        <div class="fecha-info">
                            ...
                            <strong>Días restantes:</strong> 1
                        </div>
                    </div>
                </div>
            """
    ...
    if alertas_proximas:
        html += """
            <div class="seccion seccion-proximas">
                <div class="seccion-titulo">
                    <i class="fas fa-calendar-check"></i>
                    <span>PRÓXIMAMENTE - Planificar Revisión</span>
                </div>
        """
            ...
            html += f"""
                <div class="medicamento-card card-proxima">
                    <div class="medicamento-header">
                        ...
                        <span class="badge-urgencia badge-proxima">
                            <i class="fas fa-clock"></i>
                    ...
                    <div class="medicamento-footer">
                        ...
                        <div class="fecha-info">
                            ...
                            <strong>Días restantes:</strong> {alerta['dias_restantes']}
                        </div>
                    </div>
                </div>
            """
        ...
        <div class="footer">
            <div class="footer-info">
                <div class="footer-item">
                    <i class="fas fa-clock"></i>
                    <span>Revisión: {fecha_revision}</span>
                </div>
                <div class="footer-item">
            ...
            <p style="margin-top: 15px; font-size: 0.85rem;">
                Este correo fue generado automáticamente por el sistema de control de medicamentos
            </p>
        </div>
    </div>
</body>
...
👨‍⚕️ Responsable: {info_paciente['responsable']}
